...
#define PROJ_CONFIG_I2CDATA (COMM_DATA_PROJ)
// #define PROJ_CONFIG_I2CDATA (COMM_DATA_BPF)

#define PROJ_CONFIG_SPIDATA (COMM_DATA_PROJ)
// #define PROJ_CONFIG_RTGPIOLINE (SYS_CONFIG_RTGPIO_OFF)
#define PROJ_CONFIG_RTGPIOLINE (SYS_CONFIG_RTGPIO_SWITCH)

#define PROJ_CONFIG_DSPWINDOW 200 //100ms
#define PROJ_CONFIG_ENVFMODE (ENVF_MODE_AVG) // ENVF_MODE_RMS
// #define PROJ_CONFIG_ENVFMODE (ENVF_MODE_RMS) // ENVF_MODE_RMS
